...
if( !function_exists('get_coauthors2') ){
 ...
 */
if( !function_exists('get_coauthors2_posts_links') ){
...
if( !function_exists('is_user_in_roles_coauthors2') && isset( $co_authors2 ) && method_exists($co_authors2,'is_user_in_roles') ){
